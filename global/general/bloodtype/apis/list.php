...
/**
 * global/general/bloodtype/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header bloodtype (mst_bloodtype)
...
$API = new class extends bloodtypeBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.bloodtype_id LIKE CONCAT('%', :search, '%') OR A.bloodtype_name LIKE CONCAT('%', :search, '%') "
			];
