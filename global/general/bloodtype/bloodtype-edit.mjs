...
import * as hnd from  './bloodtype-edit-hnd.mjs'
...
const obj = {
	txt_bloodtype_id: $('#pnl_edit-txt_bloodtype_id'),
	txt_bloodtype_name: $('#pnl_edit-txt_bloodtype_name')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_bloodtype_id,
		autoid: true,
		logview: 'mst_bloodtype',
...
function form_idsetup(options) {
	var objid = obj.txt_bloodtype_id
