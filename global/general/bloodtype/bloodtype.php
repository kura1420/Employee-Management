...
if (is_file(__DIR__ .'/bloodtype.php-handler.php')) {
	require_once __DIR__ .'/bloodtype.php-handler.php';
}

/**
 * global/general/bloodtype/bloodtype.php
 *
 * ===================================================================
 * Entry point Program Module bloodtype
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\bloodtype_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new bloodtype_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
