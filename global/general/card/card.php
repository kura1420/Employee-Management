...
if (is_file(__DIR__ .'/card.php-handler.php')) {
	require_once __DIR__ .'/card.php-handler.php';
}

/**
 * global/general/card/card.php
 *
 * ===================================================================
 * Entry point Program Module card
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\card_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new card_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
