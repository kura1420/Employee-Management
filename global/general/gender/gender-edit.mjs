...
import * as hnd from  './gender-edit-hnd.mjs'
...
const obj = {
	txt_gender_id: $('#pnl_edit-txt_gender_id'),
	txt_gender_name: $('#pnl_edit-txt_gender_name')
}
