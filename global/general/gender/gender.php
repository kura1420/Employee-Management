...
if (is_file(__DIR__ .'/gender.php-handler.php')) {
	require_once __DIR__ .'/gender.php-handler.php';
}

/**
 * global/general/gender/gender.php
 *
 * ===================================================================
 * Entry point Program Module gender
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\gender_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new gender_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
