...
import * as hnd from  './hubkel-edit-hnd.mjs'
...
const obj = {
	txt_hubkel_id: $('#pnl_edit-txt_hubkel_id'),
	txt_hubkel_name: $('#pnl_edit-txt_hubkel_name')
}
