...
if (is_file(__DIR__ .'/hubkel.php-handler.php')) {
	require_once __DIR__ .'/hubkel.php-handler.php';
}

/**
 * global/general/hubkel/hubkel.php
 *
 * ===================================================================
 * Entry point Program Module hubkel
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\hubkel_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new hubkel_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
