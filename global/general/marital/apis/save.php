...
/**
 * global/general/marital/apis/save.php
 *
 * ====
 * Save
 * ====
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel header marital (mst_marital)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$sqlFieldList = [
					'marital_id' => 'A.`marital_id`', 'marital_name' => 'A.`marital_name`', '_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "mst_marital A";
				$sqlWhere = $where->sql;
