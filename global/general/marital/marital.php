...
if (is_file(__DIR__ .'/marital.php-handler.php')) {
	require_once __DIR__ .'/marital.php-handler.php';
}

/**
 * global/general/marital/marital.php
 *
 * ===================================================================
 * Entry point Program Module marital
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\marital_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new marital_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
