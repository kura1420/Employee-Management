...
import * as hnd from  './pendidikan-edit-hnd.mjs'
...
const obj = {
	txt_pnddk_id: $('#pnl_edit-txt_pnddk_id'),
	txt_pnddk_name: $('#pnl_edit-txt_pnddk_name')
}
