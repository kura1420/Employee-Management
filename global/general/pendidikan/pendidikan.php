...
if (is_file(__DIR__ .'/pendidikan.php-handler.php')) {
	require_once __DIR__ .'/pendidikan.php-handler.php';
}

/**
 * global/general/pendidikan/pendidikan.php
 *
 * ===================================================================
 * Entry point Program Module pendidikan
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\pendidikan_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new pendidikan_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
