...
/**
 * global/general/period/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header period (mst_period)
...
$API = new class extends periodBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.period_id LIKE CONCAT('%', :search, '%') OR A.period_name LIKE CONCAT('%', :search, '%') "
			];
