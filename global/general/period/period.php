...
if (is_file(__DIR__ .'/period.php-handler.php')) {
	require_once __DIR__ .'/period.php-handler.php';
}

/**
 * global/general/period/period.php
 *
 * ===================================================================
 * Entry point Program Module period
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\period_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new period_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
