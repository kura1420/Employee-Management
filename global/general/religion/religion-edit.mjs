...
import * as hnd from  './religion-edit-hnd.mjs'
...
const obj = {
	txt_religion_id: $('#pnl_edit-txt_religion_id'),
	txt_religion_name: $('#pnl_edit-txt_religion_name')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_religion_id,
		autoid: false,
		logview: 'mst_religion',
