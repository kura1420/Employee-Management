...
if (is_file(__DIR__ .'/religion.php-handler.php')) {
	require_once __DIR__ .'/religion.php-handler.php';
}

/**
 * global/general/religion/religion.php
 *
 * ===================================================================
 * Entry point Program Module religion
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\religion_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new religion_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
