...
/**
 * global/general/worktype/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header worktype (mst_worktype)
...
$API = new class extends worktypeBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.worktype_id LIKE CONCAT('%', :search, '%') OR A.worktype_name LIKE CONCAT('%', :search, '%') "
			];
