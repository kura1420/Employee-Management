...
import * as hnd from  './worktype-edit-hnd.mjs'
...
const obj = {
	txt_worktype_id: $('#pnl_edit-txt_worktype_id'),
	txt_worktype_name: $('#pnl_edit-txt_worktype_name')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_worktype_id,
		autoid: true,
		logview: 'mst_worktype',
