...
if (is_file(__DIR__ .'/worktype.php-handler.php')) {
	require_once __DIR__ .'/worktype.php-handler.php';
}

/**
 * global/general/worktype/worktype.php
 *
 * ===================================================================
 * Entry point Program Module worktype
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\worktype_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new worktype_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
