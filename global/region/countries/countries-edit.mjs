...
import * as hnd from  './countries-edit-hnd.mjs'
...
const obj = {
	txt_id: $('#pnl_edit-txt_id'),
	txt_name: $('#pnl_edit-txt_name'),
	txt_iso2: $('#pnl_edit-txt_iso2'),
	txt_iso3: $('#pnl_edit-txt_iso3'),
	txt_phone_code: $('#pnl_edit-txt_phone_code'),
	chk_postcode_required: $('#pnl_edit-chk_postcode_required'),
	chk_is_eu: $('#pnl_edit-chk_is_eu')
}
