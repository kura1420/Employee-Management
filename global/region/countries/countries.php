...
if (is_file(__DIR__ .'/countries.php-handler.php')) {
	require_once __DIR__ .'/countries.php-handler.php';
}

/**
 * global/region/countries/countries.php
 *
 * ===================================================================
 * Entry point Program Module countries
 * ===================================================================
 ...
 * awal dibuat tanggal 10/06/2024
 * terakhir di generate tanggal 10/06/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\countries_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new countries_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
