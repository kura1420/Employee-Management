...
if (is_file(__DIR__ .'/districts.php-handler.php')) {
	require_once __DIR__ .'/districts.php-handler.php';
}

/**
 * global/region/districts/districts.php
 *
 * ===================================================================
 * Entry point Program Module districts
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\districts_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new districts_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
