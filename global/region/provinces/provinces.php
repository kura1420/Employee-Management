...
if (is_file(__DIR__ .'/provinces.php-handler.php')) {
	require_once __DIR__ .'/provinces.php-handler.php';
}

/**
 * global/region/provinces/provinces.php
 *
 * ===================================================================
 * Entry point Program Module provinces
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\provinces_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new provinces_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
