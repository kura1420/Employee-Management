...
if (is_file(__DIR__ .'/regencies.php-handler.php')) {
	require_once __DIR__ .'/regencies.php-handler.php';
}

/**
 * global/region/regencies/regencies.php
 *
 * ===================================================================
 * Entry point Program Module regencies
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\regencies_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new regencies_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
