...
if (is_file(__DIR__ .'/villages.php-handler.php')) {
	require_once __DIR__ .'/villages.php-handler.php';
}

/**
 * global/region/villages/villages.php
 *
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\villages_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new villages_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
