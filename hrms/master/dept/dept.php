...
if (is_file(__DIR__ .'/dept.php-handler.php')) {
	require_once __DIR__ .'/dept.php-handler.php';
}

/**
 * hrms/master/dept/dept.php
 *
 * ===================================================================
 * Entry point Program Module dept
 * ===================================================================
 ...
 * awal dibuat tanggal 04/06/2024
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\dept_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new dept_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
