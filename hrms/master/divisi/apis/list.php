...
/**
 * hrms/master/divisi/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header divisi (mst_divisi)
...
$API = new class extends divisiBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.divisi_id LIKE CONCAT('%', :search, '%') OR A.divisi_name LIKE CONCAT('%', :search, '%') "
			];
