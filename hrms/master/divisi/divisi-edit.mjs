...
import * as hnd from  './divisi-edit-hnd.mjs'
...
const obj = {
	txt_divisi_id: $('#pnl_edit-txt_divisi_id'),
	txt_divisi_name: $('#pnl_edit-txt_divisi_name'),
	cbo_dept_id: $('#pnl_edit-cbo_dept_id'),
	txt_divisi_descr: $('#pnl_edit-txt_divisi_descr'),
	chk_divisi_isdisabled: $('#pnl_edit-chk_divisi_isdisabled')
}
