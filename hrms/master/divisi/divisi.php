...
if (is_file(__DIR__ .'/divisi.php-handler.php')) {
	require_once __DIR__ .'/divisi.php-handler.php';
}

/**
 * hrms/master/divisi/divisi.php
 *
 * ===================================================================
 * Entry point Program Module divisi
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\divisi_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new divisi_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
