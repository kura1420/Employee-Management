...
/**
 * hrms/master/jabatan/apis/save.php
 *
 * ====
 * Save
 * ====
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel header jabatan (mst_jabatan)
 *
...
$API = new class extends jabatanBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->jabatan_id = strtoupper($obj->jabatan_id);
