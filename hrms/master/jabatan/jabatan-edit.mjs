...
import * as hnd from  './jabatan-edit-hnd.mjs'
...
const obj = {
	txt_jabatan_id: $('#pnl_edit-txt_jabatan_id'),
	txt_jabatan_nama: $('#pnl_edit-txt_jabatan_nama'),
	chk_jabatan_isdisabled: $('#pnl_edit-chk_jabatan_isdisabled')
}
