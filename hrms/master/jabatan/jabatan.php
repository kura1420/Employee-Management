...
if (is_file(__DIR__ .'/jabatan.php-handler.php')) {
	require_once __DIR__ .'/jabatan.php-handler.php';
}

/**
 * hrms/master/jabatan/jabatan.php
 *
 * ===================================================================
 * Entry point Program Module jabatan
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\jabatan_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new jabatan_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
