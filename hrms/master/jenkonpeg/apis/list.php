...
/**
 * hrms/master/jenkonpeg/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header jenkonpeg (mst_jenkonpeg)
...
$API = new class extends jenkonpegBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.jenkonpeg_id LIKE CONCAT('%', :search, '%') OR A.jenkonpeg_name LIKE CONCAT('%', :search, '%') "
			];
