...
import * as hnd from  './jenkonpeg-edit-hnd.mjs'
...
const obj = {
	txt_jenkonpeg_id: $('#pnl_edit-txt_jenkonpeg_id'),
	txt_jenkonpeg_name: $('#pnl_edit-txt_jenkonpeg_name'),
	txt_jenkonpeg_descr: $('#pnl_edit-txt_jenkonpeg_descr'),
	chk_jenkonpeg_isdisabled: $('#pnl_edit-chk_jenkonpeg_isdisabled'),
	chk_jenkonpeg_ispermanent: $('#pnl_edit-chk_jenkonpeg_ispermanent')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_jenkonpeg_id,
		autoid: false,
		logview: 'mst_jenkonpeg',
...
export function createnew() {
	...
	form.createnew(async (data, options)=>{
		...
		data.jenkonpeg_isdisabled = '0'
		data.jenkonpeg_ispermanent = '0'
...
function form_idsetup(options) {
	var objid = obj.txt_jenkonpeg_id
