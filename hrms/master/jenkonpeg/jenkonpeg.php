...
if (is_file(__DIR__ .'/jenkonpeg.php-handler.php')) {
	require_once __DIR__ .'/jenkonpeg.php-handler.php';
}

/**
 * hrms/master/jenkonpeg/jenkonpeg.php
 *
 * ===================================================================
 * Entry point Program Module jenkonpeg
 * ===================================================================
 ...
 * awal dibuat tanggal 05/06/2024
 * terakhir di generate tanggal 05/06/2024
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\jenkonpeg_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new jenkonpeg_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
