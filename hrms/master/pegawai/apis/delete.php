...
/**
 * hrms/master/pegawai/apis/delete.php
 *
 * ======
 * Delete
 * ======
 * Menghapus satu baris data/record berdasarkan PrimaryKey
 * pada tabel header pegawai (mst_pegawai)
 *
	...
	public function execute($data, $options) {
		...
		try {
			...
			try {
				...
				$tabletodelete = ['mst_pegawaialmt', 'mst_pegawaicard', 'mst_pegawaiattch', 'mst_pegawaikel', 'mst_pegawaipnddk', 'mst_pegawaikerja', 'mst_pegawaipnddkno', 'mst_pegawaiorg', 'mst_pegawairef'];
