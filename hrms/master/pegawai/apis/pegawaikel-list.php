...
/**
 * hrms/master/pegawai/apis/pegawaikel-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel pegawaikel pegawai (mst_pegawaikel)
...
$API = new class extends pegawaiBase {
	...
	public function execute($options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new pegawai_pegawaikelHandler($options);
			$hnd->caller = $this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			foreach ($rows as $row) {
				...
				*/
				...
				$this->addFields('hubkel_name', 'hubkel_id', $record, 'mst_hubkel', 'hubkel_name', 'hubkel_id');
				$this->addFields('name', 'pegawaikel_tmptlahir', $record, 'regencies', 'name', 'id');
