...
if (is_file(__DIR__ .'/data-pegawaiorg-handler.php')) {
	require_once __DIR__ .'/data-pegawaiorg-handler.php';
}
...
/**
 * hrms/master/pegawai/apis/pegawaiorg-save.php
 *
 * ==========
 * Detil-Save
 * ==========
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel pegawaiorg pegawai (mst_pegawaiorg)
 *
...
$API = new class extends pegawaiBase {
	...
	public function execute($data, $options, $files) {
		$event = 'on-save';
		$tablename = 'mst_pegawaiorg';
		$primarykey = 'pegawaiorg_id';
		$autoid = $options->autoid;
		$datastate = $data->_state;

		$userdata = $this->auth->session_get_user();

		$handlerclassname = "\\FGTA4\\apis\\pegawai_pegawaiorgHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new pegawai_pegawaiorgHandler($data, $options);
			$hnd->caller = &$this;
			$hnd->db = &$this->db;
			$hnd->auth = $this->auth;
		...
		try {
			...
			$sqlUpdateField  = [
					'pegawaiorg_id', 'pegawaiorg_nama', 'pegawaiorg_sebagai', 'regency_id',
					'pegawaiorg_tahun', 'pegawaiorg_descr', 'pegawai_id'
			];
			...
			try {
				...
				// result
				$options->criteria = [
					"pegawaiorg_id" => $obj->pegawaiorg_id
				];

				$criteriaValues = [
					"pegawaiorg_id" => " pegawaiorg_id = :pegawaiorg_id "
				];
				...
				$sqlFieldList = [
					'pegawaiorg_id' => 'A.`pegawaiorg_id`', 'pegawaiorg_nama' => 'A.`pegawaiorg_nama`', 'pegawaiorg_sebagai' => 'A.`pegawaiorg_sebagai`', 'regency_id' => 'A.`regency_id`',
					'pegawaiorg_tahun' => 'A.`pegawaiorg_tahun`', 'pegawaiorg_descr' => 'A.`pegawaiorg_descr`', 'pegawai_id' => 'A.`pegawai_id`', '_createby' => 'A.`_createby`',
					'_createby' => 'A.`_createby`', '_createdate' => 'A.`_createdate`', '_modifyby' => 'A.`_modifyby`', '_modifydate' => 'A.`_modifydate`'
				];
				$sqlFromTable = "mst_pegawaiorg A";
				$sqlWhere = $where->sql;
