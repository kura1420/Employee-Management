...
/**
 * hrms/master/pegawai/apis/xapi.base.php
 *
 * pegawaiBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul pegawai
 *
...
class pegawaiBase extends WebAPI {
	...
	protected $main_tablename = "mst_pegawai";
	protected $main_primarykey = "pegawai_id";
	protected $main_field_version = "pegawai_version";	
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*pegawai*/.txt";
		// debug::disable();
