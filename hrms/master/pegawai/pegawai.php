...
if (is_file(__DIR__ .'/pegawai.php-handler.php')) {
	require_once __DIR__ .'/pegawai.php-handler.php';
}

/**
 * hrms/master/pegawai/pegawai.php
 *
 * ===================================================================
 * Entry point Program Module pegawai
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\pegawai_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new pegawai_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
