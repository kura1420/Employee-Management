...
/**
 * hrms/master/penempatan/apis/save.php
 *
 * ====
 * Save
 * ====
 * Menampilkan satu baris data/record sesuai PrimaryKey,
 * dari tabel header penempatan (mst_penempatan)
 *
...
$API = new class extends penempatanBase {
	...
	public function execute($data, $options) {
		$event = 'on-save';
		$tablename = 'mst_penempatan';
		$primarykey = 'penempatan_id';
		...
		try {
			...
			$obj->penempatan_id = strtoupper($obj->penempatan_id);


			if ($obj->penempatan_telp=='') { $obj->penempatan_telp = '--NULL--'; }
			if ($obj->penempatan_email=='') { $obj->penempatan_email = '--NULL--'; }
			...
			try {
				...
				// result
				$options->criteria = [
					"penempatan_id" => $obj->penempatan_id
				];

				$criteriaValues = [
					"penempatan_id" => " penempatan_id = :penempatan_id "
				];
