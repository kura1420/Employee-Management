...
import * as hnd from  './penempatan-edit-hnd.mjs'
...
const obj = {
	txt_penempatan_id: $('#pnl_edit-txt_penempatan_id'),
	txt_penempatan_nama: $('#pnl_edit-txt_penempatan_nama'),
	txt_penempatan_telp: $('#pnl_edit-txt_penempatan_telp'),
	txt_penempatan_email: $('#pnl_edit-txt_penempatan_email'),
	cbo_province_id: $('#pnl_edit-cbo_province_id'),
	cbo_regency_id: $('#pnl_edit-cbo_regency_id'),
	txt_penempatan_alamat: $('#pnl_edit-txt_penempatan_alamat'),
	chk_penempatan_isdisabled: $('#pnl_edit-chk_penempatan_isdisabled')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_penempatan_id,
		autoid: false,
		logview: 'mst_penempatan',
...
function form_idsetup(options) {
	var objid = obj.txt_penempatan_id
