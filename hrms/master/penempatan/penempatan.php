...
if (is_file(__DIR__ .'/penempatan.php-handler.php')) {
	require_once __DIR__ .'/penempatan.php-handler.php';
}

/**
 * hrms/master/penempatan/penempatan.php
 *
 * ===================================================================
 * Entry point Program Module penempatan
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\penempatan_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new penempatan_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
