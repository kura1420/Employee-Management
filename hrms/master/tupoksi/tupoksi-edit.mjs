...
import * as hnd from  './tupoksi-edit-hnd.mjs'
...
const obj = {
	txt_tupoksi_id: $('#pnl_edit-txt_tupoksi_id'),
	cbo_dept_id: $('#pnl_edit-cbo_dept_id'),
	cbo_divisi_id: $('#pnl_edit-cbo_divisi_id'),
	cbo_jabatan_id: $('#pnl_edit-cbo_jabatan_id'),
	txt_tupoksi_tugas: $('#pnl_edit-txt_tupoksi_tugas'),
	txt_tupoksi_fungsi: $('#pnl_edit-txt_tupoksi_fungsi'),
	chk_tupoksi_isdisabled: $('#pnl_edit-chk_tupoksi_isdisabled')
}
