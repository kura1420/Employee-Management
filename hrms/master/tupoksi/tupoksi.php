...
if (is_file(__DIR__ .'/tupoksi.php-handler.php')) {
	require_once __DIR__ .'/tupoksi.php-handler.php';
}

/**
 * hrms/master/tupoksi/tupoksi.php
 *
 * ===================================================================
 * Entry point Program Module tupoksi
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\tupoksi_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new tupoksi_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
