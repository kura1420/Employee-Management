...
/**
 * hrms/transaction/konpeg/apis/xapi.base.php
 *
 * konpegBase
 * Kelas dasar untuk keperluan-keperluan api
 * kelas ini harus di-inherit untuk semua api pada modul konpeg
 *
 ...
 * tanggal 10/06/2024
 */
class konpegBase extends WebAPI {

	protected $main_tablename = "trn_konpeg";
	protected $main_primarykey = "konpeg_id";
	protected $main_field_version = "konpeg_version";	
	...
	function __construct() {
		...
		// $logfilepath = __LOCALDB_DIR . "/output//*konpeg*/.txt";
		// debug::disable();
