...
if (is_file(__DIR__ .'/konpeg.php-handler.php')) {
	require_once __DIR__ .'/konpeg.php-handler.php';
}

/**
 * hrms/transaction/konpeg/konpeg.php
 *
 * ===================================================================
 * Entry point Program Module konpeg
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\konpeg_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new konpeg_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
